"""Explicit Twelve Data ingestion-to-price-only-feature orchestration."""
...
class TwelveDataDailyPriceFeatureService:
    ingestion_service: TwelveDataDailyMarketBarIngestionService
    feature_service: DailyPriceTechnicalFeatureSnapshotService
    clock: Clock
